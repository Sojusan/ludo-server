...
void main()
{
	...
	game_settings.fields["gray_12"].nextField = BoardField("gray_13");
	game_settings.fields["gray_13"].nextField = BoardField("gray_14");
	game_settings.fields["gray_14"].nextField = BoardField("gray_15");
	game_settings.fields["gray_15"].nextField = BoardField("gray_16");
	game_settings.fields["gray_16"].nextField = BoardField("gray_17");
	game_settings.fields["gray_17"].nextField = BoardField("gray_18");
	game_settings.fields["gray_18"].nextField = BoardField("gray_19");
	game_settings.fields["gray_19"].nextField = BoardField("gray_11");
	/// Blue end gate
