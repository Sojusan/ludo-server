...
/// Get the `FieldPawnsOwner` of the player whose pawns are on this field and it is not his start point
string getEnemyPlayerOnStartPoint(string destination_field, FieldPawnsOwner[] field_info, ref GameSettings settings) {
    foreach (field; field_info) {
        /// Check if this is the player start field
