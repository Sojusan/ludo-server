            ...
            if(Socket.select(readSet, null, null)) {
                foreach(client; connectedClients) {
                    if(readSet.isSet(client)) {
                        ...
                        ubyte[] got = client.receive(buffer);
                        JSONValue client_data = parseJSON(got);
                ...
                if(readSet.isSet(listener)) {
                    ...
                    if (connectedClients.length > 3) {
                        ...
                        if (!settings.gameStarted) {
                            ...
                            foreach(player2; settings.players) {
                                logMessage(player2.nickname, fg.light_blue);
                                logMessage(player2.color, fg.light_blue);
                            }
