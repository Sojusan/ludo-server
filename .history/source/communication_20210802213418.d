...
void processServerCommand(string[] args, ref GameSettings settings) {
    ...
    switch(args[0]) {
        ...
        case "move_pawn":
            ...
            data_to_send.object["source_field"] = JSONValue(args[2]);
            data_to_send.object["destination_field"] = JSONValue(args[3]);
            /// Update pawn location on server side
            settings.players[args[1]].pawns[pawn_clicked] = destinationField;
