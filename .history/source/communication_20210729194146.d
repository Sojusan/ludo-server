...
bool clickedEnemyBaseField(string field, string player_color) {
    ...
    if (player_color == "green") {
        if(canFind([
            "yellow_base_1", "yellow_base_2", "yellow_base_3", "yellow_base_4", "blue_base_1", "blue_base_2", "blue_base_3",
            "blue_base_4", "red_base_1", "red_base_2", "red_base_3", "red_base_4"
        ], field)) {
            return true;
        }
    ...
    if (player_color == "blue") {
        if(canFind([
            "green_base_1", "green_base_2", "green_base_3", "green_base_4", "yellow_base_1", "yellow_base_2", "yellow_base_3",
            "blue_base_4", "red_base_1", "red_base_2", "red_base_3", "red_base_4"
        ], field)) {
            return true;
        }
    ...
    if (player_color == "red") {
        if(canFind([
            "green_base_1", "green_base_2", "green_base_3", "green_base_4", "blue_base_1", "blue_base_2", "blue_base_3",
            "blue_base_4", "yellow_base_1", "yellow_base_2", "yellow_base_3", "red_base_4"
        ], field)) {
            return true;
        }
    }
