...
void main()
{
	...
	game_settings.fields["gray_21"].nextField = BoardField("gray_22");
	game_settings.fields["gray_22"].nextField = BoardField("gray_23");
	game_settings.fields["gray_23"].nextField = BoardField("gray_24");
	game_settings.fields["gray_24"].nextField = BoardField("gray_25");
	game_settings.fields["gray_25"].nextField = BoardField("gray_26");
	game_settings.fields["gray_26"].nextField = BoardField("gray_27");
	game_settings.fields["gray_27"].nextField = BoardField("gray_28");
	game_settings.fields["gray_28"].nextField = BoardField("gray_20");
	/// Yellow end gate
