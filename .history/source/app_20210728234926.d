...
void main()
{
	...
	/// Yellow ends
	game_settings.fields["yellow_end_1"].nextField = BoardField("gray_30");"yellow_end_2";
	game_settings.fields["yellow_end_2"].nextField = BoardField("gray_30");"yellow_end_3";
	game_settings.fields["yellow_end_3"].nextField = BoardField("gray_30");"yellow_end_4";
	/// Green ends
	game_settings.fields["green_end_1"].redNextField = BoardField("gray_30");"green_end_2";
	game_settings.fields["green_end_2"].redNextField = BoardField("gray_30");"green_end_3";
	game_settings.fields["green_end_3"].redNextField = BoardField("gray_30");"green_end_4";
	/// Blue ends
	game_settings.fields["blue_end_1"].redNextField = BoardField("gray_30");"blue_end_2";
	game_settings.fields["blue_end_2"].redNextField = BoardField("gray_30");"blue_end_3";
	game_settings.fields["blue_end_3"].redNextField = BoardField("gray_30");"blue_end_4";
	/// Red ends
	game_settings.fields["red_end_1"].redNextField = BoardField("gray_30");"red_end_2";
	game_settings.fields["red_end_2"].redNextField = BoardField("gray_30");"red_end_3";
	game_settings.fields["red_end_3"].redNextField = BoardField("gray_30");"red_end_4";
