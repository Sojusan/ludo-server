...
void main()
{
	...
	game_settings.fields["gray_30"].nextField = BoardField("gray_31");
	game_settings.fields["gray_31"].nextField = BoardField("gray_32");
	game_settings.fields["gray_32"].nextField = BoardField("gray_33");
	game_settings.fields["gray_33"].nextField = BoardField("gray_34");
	game_settings.fields["gray_34"].nextField = BoardField("gray_35");
	game_settings.fields["gray_35"].nextField = BoardField("gray_36");
	game_settings.fields["gray_36"].nextField = BoardField("gray_1");
	/// Yellow ends
