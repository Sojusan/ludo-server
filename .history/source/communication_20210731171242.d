...
string getPawnBaseField(string pawn) {
    if (canFind(to_delete_pawns, "yellow_pawn_1")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "yellow_base_1");
    }
    if (canFind(to_delete_pawns, "yellow_pawn_2")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "yellow_base_2");
    }
    if (canFind(to_delete_pawns, "yellow_pawn_3")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "yellow_base_3");
    }
    if (canFind(to_delete_pawns, "yellow_pawn_4")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "yellow_base_4");
    }
    if (canFind(to_delete_pawns, "green_pawn_1")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "green_base_1");
    }
    if (canFind(to_delete_pawns, "green_pawn_2")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "green_base_2");
    }
    if (canFind(to_delete_pawns, "green_pawn_3")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "green_base_3");
    }
    if (canFind(to_delete_pawns, "green_pawn_4")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "green_base_4");
    }
    if (canFind(to_delete_pawns, "blue_pawn_1")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "blue_base_1");
    }
    if (canFind(to_delete_pawns, "blue_pawn_2")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "blue_base_2");
    }
    if (canFind(to_delete_pawns, "blue_pawn_3")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "blue_base_3");
    }
    if (canFind(to_delete_pawns, "blue_pawn_4")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "blue_base_4");
    }
    if (canFind(to_delete_pawns, "red_pawn_1")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "red_base_1");
    }
    if (canFind(to_delete_pawns, "red_pawn_2")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "red_base_2");
    }
    if (canFind(to_delete_pawns, "red_pawn_3")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "red_base_3");
    }
    if (canFind(to_delete_pawns, "red_pawn_4")) {
        gamePage._gameBoard.movePlayerPawn(source_field, "red_base_4");
    }
}
