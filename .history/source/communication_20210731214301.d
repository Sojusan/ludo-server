...
/// Check if field is one of the start fields
bool isOneOfTheStartFields(string field) {
    if (canFind(["yellow_start", "green_start", "blue_start", "red_start"], field)) {
        return true;
    }
    return false;
}
